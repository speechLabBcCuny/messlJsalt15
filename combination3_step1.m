...
outDir = '/scratch/near/CHiME3/v3/lstm_initial_messl_output/';
...
'mrfCompatExpSched', [0 0 0 0 0 0 0 0 .2], 'mrfHardCompatExp', 5 , ...
 'mrfCompatFile', '~mandelm/data8/messlData/ibmNeighborCountsSimple.mat', 'mrfLbpIter', 4, 'vis', 1), ...
 workDir, outDir, [10 10], 1, 0, 1,'.[de]t05.*\.CH1\.wav',0); 
